...
Usage:
    python run_inspect.py path/to/video.mp4
    python run_inspect.py path/to/video.mp4 --model best_detect.pt
    python run_inspect.py path/to/image.jpg --report
    python run_inspect.py path/to/folder/ --batch --report
"""
